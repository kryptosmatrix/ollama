#!/usr/bin/env python3
"""OQ-1 measurement harness (continuation 13, Thole).
...
def run_arm(arm):
    ...
    probes = [
        ('shift_default_long', {}, msgs_long, 1400),
        ('shift_false_long', {'shift': False}, msgs_long, 1400),
        ('oversize_default', {}, msgs_over, 64),
        ('oversize_shift_false', {'shift': False}, msgs_over, 64),
    ]
    results = []
