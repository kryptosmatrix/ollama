...
const options={...parsed.options,noEmit:false,allowImportingTsExtensions:false,removeComments:true,sourceMap:false,inlineSourceMap:false};
...
const a=emit(raw),b=emit(candidate);fs.writeFileSync(path.join(base,"program-r2-before.js"),a);fs.writeFileSync(path.join(base,"program-r2-after.js"),b);
